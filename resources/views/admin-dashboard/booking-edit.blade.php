                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($booking->payment_reference)
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $booking->payment_reference }}" readonly>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="special_requests" id="special_requests" class="form-control" rows="4">{{ old('special_requests', $booking->special_requests) }}</textarea>
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    @if($booking->payment_reference)
                                        <small class="text-muted">Reference: {{ $booking->payment_reference }}</small>
                                    @endif
                                </div>
                            </div>
                            @endif
