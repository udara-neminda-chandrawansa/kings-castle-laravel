            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('tour-packages.store') }}" method="POST" id="tourPackageForm">
                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="image_path" id="image_path"
                                                        class="form-control"
                                                        value="{{ old('image_path', 'assets/img/tours/helicopter1.jpg') }}"
...
<script>
    ...
    function updatePreview() {
        ...
        const imagePath = document.getElementById('image_path').value || 'assets/img/tours/helicopter1.jpg';
