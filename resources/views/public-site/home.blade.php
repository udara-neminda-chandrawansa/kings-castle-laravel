    ...
    <div class="container">
      <div class="row gy-40 align-items-center">
        ...
        <div class="col-lg-6 col-xxl-4">
          <div class="img-box1">
            <div class="img1">
              <img src="assets/img/drive-images-2-webp/kc28-se.webp" alt="About" style="height: 700px;aspect-ratio: 9/16; object-fit: cover;"/>
            </div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="brand-item">
                <a href="#"><img class="original" src="assets/img/travel-plat/booking.svg" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/>
                  <img class="gray" src="assets/img/travel-plat/booking.svg" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/></a>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="brand-item">
                <a href="#"><img class="original" src="assets/img/travel-plat/trip-advisior-new.png" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/>
                  <img class="gray" src="assets/img/travel-plat/trip-advisior-new.png" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/></a>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="brand-item">
                <a href="#"><img class="original" src="assets/img/travel-plat/agoda.png" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/>
                  <img class="gray" src="assets/img/travel-plat/agoda.png" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/></a>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="brand-item">
                <a href="#"><img class="original" src="assets/img/travel-plat/expedia.png" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/>
                  <img class="gray" src="assets/img/travel-plat/expedia.png" alt="Brand Logo" style="height: 100%; width: 100%; object-fit: contain;"/></a>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="brand-item">
        ...
        <div class="12">
          <div class="room-card style2 style-flex" data-bg-src="assets/img/shape/room-shape.png">
            ...
            <div class="box-content">
              ...
              <p class="box-text">
                Horton Plains National Park is an astounding protected area located about 32 kilometers from Nuwara Eliya town. This misty grassland plateau sits at an altitude of over 2,100 meters above sea level and serves as a biodiversity hotspot with numerous endemic species. The park is famous for its 9-kilometer circular hiking trail leading to "World's End," a sheer cliff with a breathtaking 880-meter drop offering spectacular panoramic views of the tea estates, villages, and distant mountains. Another highlight is the beautiful Baker's Falls, a picturesque waterfall named after the famous explorer Samuel Baker. Wildlife enthusiasts can spot sambar deer, purple-faced langur monkeys, and numerous bird species. It's advisable to start early around 6 am, as the views are often obscured by mist after mid-morning.
              </p>
              <a href="#" class="th-btn2 style2">VIEW DETAILS</a>
            </div>
          </div>
