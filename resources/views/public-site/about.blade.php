...
<style>
    .service-box .box-text, .service-box .box-title a {
      color: white;
    }
</style>
  ...
  <section class="overflow-hidden space">
    <div class="container">
      <div class="title-area text-center">
        <span class="sub-title2 style1">LUXURY COMFORT</span>
        <h2 class="sec-title">Featured rooms & suits</h2>
      </div>
      <div class="row gy-4">
        <div class="col-lg-6">
          <div class="room-box">
        ...
        <div class="col-lg-6">
          <div class="room-box">
            <div class="box-img">
              <img src="assets/img/drive-images-2-webp/kc32.webp" alt="" />
            </div>
